...
public class KiddoTester3 {
	...
	public static void main(String[] args) {
	    ...
	    Student s5 = new Student("Jebat Iskandar", "080808055002", 9, kc1);
	    kiddoList.add(s5);
	    s5.addLesson(new Lesson("Handicraft", 95));
	    s5.addLesson(new Lesson("Clay art", 82));
