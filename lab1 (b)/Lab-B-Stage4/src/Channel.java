...
public class Channel {
	...
	public void listTVProgramFuture(){
		for(TVProgram a : list ){
			if(a.getNoOfViewers() >= 1000){
				System.out.println("Program name : "+a.getName()+", Verdict : Continue");
			}
			else{
				System.out.println("Program name : "+a.getName()+", Verdict : Stopped");
			}
		}
	}
